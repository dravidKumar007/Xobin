    ...
    <div>
      <div className="navbar bg-black">
        <div className="flex-1">
          <Link href={"/"} className="btn btn-ghost text-xl">TheMealDB</Link>
        </div>
          ...
          <div className="flex flex-wrap justify-center gap-6">
            {meals.map((meal) => (
              <Link href={`/recipe/${meal.idMeal}`} key={meal.idMeal}>
                <div className="card w-80 bg-black border shadow-md hover:shadow-xl transition-transform hover:scale-105">
                  <figure>
                    <img
